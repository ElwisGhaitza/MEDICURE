...
<div class="container" style="padding-bottom: 300px;">
	<h2 style=" width: 100%; border-bottom: 4px solid #192655;"><b>Keranjang</b></h2>
				...
				if($jml > 0){
					...
					<?php 
					 ...
					 ?>
						...
						<tr>
							<td colspan="7" style="text-align: right; font-weight: bold;">Total Belanja Anda = Rp.<?= number_format($hasil); ?></td>
						</tr>
						<tr>
